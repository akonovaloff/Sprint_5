...
class RegistrationPageLocators:
    ...
    REGISTRATION_NAME_INPUT = (By.XPATH, "//label[text()='Имя']/../input")
    # Поле ввода email при регистрации
    REGISTRATION_EMAIL_INPUT = (By.XPATH, "//label[text()='Email']/../input")
    # Поле ввода пароля при регистрации
    REGISTRATION_PASSWORD_INPUT = (By.XPATH, "//label[text()='Пароль']/../input")
...
class ConstructorLocators:
    ...
    FILLINGS_PARENT_SECTION = (By.XPATH, "//span[text()='Начинки']/..")
    BURGER_INGREDIENTS_SECTION = (By.XPATH, "//section[@class='BurgerIngredients_ingredients__1N8v2']")

class ForgotPasswordPageLocators:
    # Поле ввода email для восстановления пароля
    FORGOT_PASSWORD_EMAIL_INPUT = (By.XPATH, "//label[text()='Email']/../input")
...
class ResetPasswordPageLocators:
    ...
    RESET_PASSWORD_PASSWORD_INPUT = (By.XPATH, "//label[text()='Пароль']/../input")
    # Поле ввода кода из письма
    RESET_PASSWORD_LETTER_CODE = (By.XPATH, "//label[text()='Введите код из письма']/../input")
